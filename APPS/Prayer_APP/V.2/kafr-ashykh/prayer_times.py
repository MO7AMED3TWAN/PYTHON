...
#API
import json
url = 'http://api.aladhan.com/v1/timingsByCity?city=kafrashykh&country=Egypt'
...
def updateTime():
    ...
    for i in range(len(timings)):
        ...
        if(timeNow == timePray):
            playsound(r'C:\Users\MoHaMeD\Desktop\PYTHON-SYNTAX\APPS\Prayer_APP\V.2\kafr-ashykh\s2.mp3')
